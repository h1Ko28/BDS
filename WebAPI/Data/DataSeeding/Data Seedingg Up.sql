...
select 'Ho Chi Minh',@UserID,getdate(),'Viet Nam'
union
select 'Ha Noi',@UserID,getdate(),'Viet Nam'
union
select 'Quy Nhon',@UserID,getdate(),'Viet Nam'
union
select 'Tuy Hoa',@UserID,getdate(),'Viet Nam'
union
select 'Lam Dong',@UserID,getdate(),'Viet Nam'
...
1, --Gated
300, -- Maintenance
'2024-01-01', -- Establishment or Posession on
0, --Age
